...
class GNTransformer_phonon_v2(nn.Module):
    ...
    def forward(self, g):
        ...
        x,z, edge_attr, energies = self.GN_encoder(x = g.x, z=g.z, edge_attr = edge_attr, batch = g.batch, energies = energies)
